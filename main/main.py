...
# --- Setup Paths for 'cfg' and 'tools' folders FIRST ---
script_dir = os.path.dirname(os.path.abspath(__file__))
# Go up one level to the parent directory (Command-Prompt folder)
...
# --- Try importing external modules AFTER path setup ---
try:
    from config_loader import ConfigLoader
except ImportError as e:
    print(f"Warning: Could not import ConfigLoader: {e}")

    # Fallback ConfigLoader if external module not found
    class ConfigLoader:
        def __init__(self):
            self.base_dir = "cfg"
...
class TkinterCLI:
    ...
    def write_to_screen(self, text, color=None):
        ...
        # Override specific named colors with theme values if they match
        if color == "red":
    ...
    def process_command(self, event):
        ...
        # Use Prompt Color for the directory/prompt line
    ...
    def execute_logic(self, cmd, args, silent=False):
        ...
        # Check External Tools (Network, Task Manager, etc.)
